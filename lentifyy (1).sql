...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 24 Apr 2026 pada 18.48
...
(22, '30082008', 'pulang', 1, 4, 10, '2023', 7, -1, 'ini ', '1776668120_384f1f71c6bd2db5ac0f.webp'),
(23, '3008203', 'bandung after rain', 1, 4, 13, '2014', 52, 45, 'di bandung', '1776668210_bde0a5d41e47876bc997.jpg'),
(25, '	6026064060', 'PISIKOTES TNI POLRI', 10, 17, 21, '2026', 15, 6, 'buku tes pisikotes terbaru tahun ini', '1776700159_7f0cffaa7c44bd31a438.png'),
(26, '978-602-5710-55-1', 'TOP No. 1 TKA (Tes Kemampuan Akademik) SMA/MA IPA 2025/2026', 11, 19, 22, '2025', 10, 4, 'Menggunakan metode pembelajaran bertahap, dilengkapi ringkasan materi padat serta ribuan soal drilling (latihan) beserta kunci jawaban dan pembahasan mendalam.', '1776700667_ebd797e21fe34e129d5e.avif'),
(27, ' 978-623-8618-01-9', 'Buku Paten UTBK SNBT TPS 2025 (Tes Potensi Skolastik) Update Terbaru', 12, 20, 23, '2024', 20, 20, 'Buku ini berfokus pada 7 subtes TPS. Dilengkapi dengan Field Report (FR) soal asli 2023-2024, paket drilling soal, prediksi SNBT, bonus simulasi android, dan video bedah soal. Sangat cocok untuk penguatan dasar.', '1776701073_d806b1acbf5524194603.png');
...
(155, '2026-04-24', '2026-04-29', 'dipinjam', 8, 'ambil');
...
--
ALTER TABLE `peminjaman`
  MODIFY `id_peminjaman` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=156;
...
--
ALTER TABLE `pengembalian`
  MODIFY `id_pengembalian` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
