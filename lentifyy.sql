...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 21 Apr 2026 pada 16.55
...
(22, '30082008', 'pulang', 1, 4, 10, '2023', 2, 2, 'ini ', '1776668120_384f1f71c6bd2db5ac0f.webp'),
(23, '3008203', 'bandung after rain', 1, 4, 13, '2014', 52, 52, 'di bandung', '1776668210_bde0a5d41e47876bc997.jpg'),
...
INSERT INTO `peminjaman` (`id_peminjaman`, `tanggal_pinjam`, `tanggal_kembali`, `status`, `id`, `id_buku`, `metode`) VALUES
(108, '2026-04-21', '2026-04-26', '', 2, NULL, 'ambil'),
(109, '2026-04-21', '2026-04-26', 'dipinjam', 2, NULL, 'antar');
...
INSERT INTO `pengiriman` (`id_pengiriman`, `id_peminjaman`, `alamat`, `biaya`, `status`, `tanggal_kirim`, `petugas_id`) VALUES
...
--
ALTER TABLE `peminjaman`
  MODIFY `id_peminjaman` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=110;
...
--
ALTER TABLE `pengembalian`
  MODIFY `id_pengembalian` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
